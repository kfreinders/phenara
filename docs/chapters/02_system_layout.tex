...
Phenara is organized as a workflow rather than as a single application. The
...
Phenara uses separate scripts for scheduling, image capture, image analysis,
...
A typical Phenara project or experiment directory contains folders for captured
