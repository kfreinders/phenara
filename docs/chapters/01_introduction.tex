...
Phenara is an image-based plant phenotyping system for controlled-environment
...
programming experience, but Phenara is currently command-line based and assumes
basic familiarity with running terminal commands and working with text-based
configuration files.

\subsection{What Phenara Does}

Phenara supports a complete basic workflow for image-based plant phenotyping.
...
This manual explains how to install Phenara for automated image acquisition,
